...
public class CreepsCapabilityHandler
{
    ...
    public static void attachItemCapabilities(AttachCapabilitiesEvent<ItemStack> event)
    {
        ...
        if (item == CreepsItemHandler.petRadio5000)
        {
            event.addCapability(new ResourceLocation(MoreCreepsAndWeirdos.modid, "pet_radio_picked_up"), new GuineaPigPickedUpProvider());
        }
    }
