...
public class EntitySneakySal extends EntityCreepBase implements IRangedAttackMob, IMob
{
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor)
    {
        ...
        bullet.shoot(d0, d1 + d3 * 0.20000000298023224D, d2, 1.6F, (float)(14 - this.world.getDifficulty().getDifficultyId() * 4));
        world.spawnEntity(bullet);
        playSound(CreepsSoundHandler.bulletSound, 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));
    }
    ...
    public void ripOff()
    {
        ...
        if (rand.nextInt(9) == 0)
        {
            ...
            {
                case 1:
                    dropItem(CreepsItemHandler.sundae, 1);
                    break;
                case 2:
    ...
    @Override
    public boolean attackEntityFrom(DamageSource damageSource, float amt)
    {
