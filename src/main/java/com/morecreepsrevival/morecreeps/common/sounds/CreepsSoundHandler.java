...
public class CreepsSoundHandler
{
    ...
    public static final SoundEvent petRadioDropSound = createSound("petradiodrop");
    public static final SoundEvent petRadioPickupSound = createSound("petradiopickup");
