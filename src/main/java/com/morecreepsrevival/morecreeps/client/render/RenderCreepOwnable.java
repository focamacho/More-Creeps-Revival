...
public class RenderCreepOwnable<T extends EntityCreepBaseOwnable> extends RenderCreep<T> {

    public RenderCreepOwnable(RenderManager renderManager, ModelBase modelBase, float shadowSize) {
        super(renderManager, modelBase, shadowSize);
    }

    public RenderCreepOwnable(RenderManager renderManager, ModelBase modelBase) {
