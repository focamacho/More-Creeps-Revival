...
public class ModelGrowbotGregg extends ModelBiped
{
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
    {
        ...
        this.footR.rotateAngleX = this.bipedRightLeg.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
        this.footL.rotateAngleX = this.bipedLeftLeg.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
        this.footR.rotateAngleY = this.bipedRightLeg.rotateAngleY = 0.0F;
        this.footL.rotateAngleY = this.bipedLeftLeg.rotateAngleY = 0.0F;
